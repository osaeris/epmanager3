 ...
 <body>
   <div id='container'>
     <div id='header'>
      ...
      <div id='formdiv'>
<h2>Add group lecturer</h2>
<p class='info'>On this form you can add a lecturer to a group of students. Use this in conjunction with delete group lecturer to change the lecturer for a particular group. If you select a lecturer who is already attached to an ePortfolio, no change will be made to that ePortfolio.</p>
<?php
get_menu(); 
...
// part here
 ...
 <fieldset>
   <legend>Select students by holding CTRL + Click. Select groups by SHIFT + Click</legend>
      ...
      <input type="submit" name="create" value="create lecturer!" />
...
<?php      }
     ...
     else
     {
         ...
         $errorcode=$errorcode . "<p><a href='addgrouplecturer.php'>&larr;&nbsp;back</a></p>";
         echo $errorcode;
     }
?>
